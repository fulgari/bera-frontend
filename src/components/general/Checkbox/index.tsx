...
export default function Checkbox (props: CheckboxProps) {
  ...
  return (
    <div className={cx(s.checkbox, className)} style={style} {...rest}>
      {isChecked
        ? <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" fill={fillColor ?? '#fff'} height="16px" width="16px" version="1.1" viewBox="0 0 490 490" xmlSpace="preserve">
